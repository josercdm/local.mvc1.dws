            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <script>
                            $('select[name=environment]').val('<?= isset($response['environment']) ? $response['environment'] : '' ?>')
                        </script>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <script>
                            $('select[name=protocol]').val('<?= isset($response['protocol']) ? $response['protocol'] : '' ?>')
                        </script>
                    </div>
                </div>
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        <script>
                            $('select[name=mail_auth]').val('<?= isset($response['mail_auth']) ? $response['mail_auth'] : '' ?>')
                        </script>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <script>
                            $('select[name=mail_secure]').val('<?= isset($response['mail_secure']) ? $response['mail_secure'] : '' ?>')
                        </script>
                    </div>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        <script>
                            $('select[name=mail_sendtype]').val('<?= isset($response['mail_sendtype']) ? $response['mail_sendtype'] : '' ?>')
                        </script>
                    </div>
                </div>
                <div class="col-lg-4">
